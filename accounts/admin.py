...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'plan', 'is_test_data', 'company_name', 'position_title', 'email_signature_mode', 'analyses_this_month', 'created_at')
    list_filter = ('plan', 'is_test_data', 'created_at')
